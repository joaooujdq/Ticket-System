...
public class BackendTsApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception{
		...
		Recado r1 = new Recado(1, "nome_emp", "nome_func", true, 3,"setor", "mensagem","data", "hora", e1, f1);
		Recado r2 = new Recado(2, "2nome_emp", "2nome_func", true, 3,"2setor", "2mensagem","2data", "2hora", e2, f2);
